...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=[
                'data/my_small_data/instances_training.json'],
            img_prefix=[
                'data/my_small_data/imgs/training'],
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file='data/my_small_data/instances_test.json',
        img_prefix='data/my_small_data/imgs',
